...
def build_translation_prompt(
    ...
    system = (
        ...
        f"5. Return ONLY the JSON array specified below. No prose, no code fences.\n\n"
        f"{glossary_block}"
    )
...
def build_math_fix_prompt(
    ...
    system = (
        ...
        "**Pattern B — One-label-many-formulas** (label with stacked formulas):\n"
        "Entry has 1 label + multiple formulas. Use a column grid (one cell per line):\n"
