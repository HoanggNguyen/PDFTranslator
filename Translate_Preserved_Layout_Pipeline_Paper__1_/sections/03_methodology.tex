...
(2.47~mm) readability floor, the 80~pt (28.22~mm) expansion cap and the
table-cell scale factor
(Supplementary Material, Implementation Notes).
...
6~pt (2.12~mm) ring around the element at $2\times$ raster scale; contaminated
light rings
...
the Supplementary Material, End-to-End Document Benchmark.
...
in the Implementation Notes in the Supplementary Material.
