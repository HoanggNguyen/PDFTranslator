...
from the DocLayNet v1.2 test split: 34 pages each from scientific articles,
...
The metric set separates three questions. Pixel preservation measures unchanged
non-text content and, more specifically, annotated pictures and formulas.
Harmful-overflow and ink-collision measures detect translated text that invades
another region or visibly merges with neighbouring ink. Reading-order
...
composition, coverage and complete confidence intervals are reported in
