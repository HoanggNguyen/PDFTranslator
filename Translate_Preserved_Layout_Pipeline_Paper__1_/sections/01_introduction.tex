...
The hypothesis is then examined through three independent measurements, defined
in Section~\ref{subsec:method-eval}. These are stage-level measurements: they
identify mechanisms and failure slices, but they do not replace a future
end-to-end benchmark of reconstructed translated PDFs.
