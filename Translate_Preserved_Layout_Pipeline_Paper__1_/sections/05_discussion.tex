...
The stage-level results identify the mechanisms that constrain this
implementation. The final-artifact benchmark separately compares the systems on
a common born-digital English-to-Vietnamese task.
...
Several limits remain. First, the end-to-end comparison is restricted to
born-digital English-to-Vietnamese pages and uses reference-free translation
quality estimation; matched scanned pages and human target references remain
future work. Second, the cell stage is scored only for geometry and only on cropped
...
The next benchmark should add matched scanned and mixed-PDF strata, human
translation references and visual quality ratings.
