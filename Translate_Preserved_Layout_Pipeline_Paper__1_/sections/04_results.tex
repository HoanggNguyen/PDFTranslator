...
Appendices~\ref{app:parser-slices}, \ref{app:translation-full}
and~\ref{app:e2e-benchmark}.
...
Appendix~\ref{app:e2e-benchmark} gives all seven quality measures and controls.
...
scores are in Table~\ref{tab:app-e2e-full}.}
