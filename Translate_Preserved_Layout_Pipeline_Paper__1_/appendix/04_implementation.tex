...
\midrule
Font-size cluster width $\epsilon$ & 2.0~pt (0.71~mm) \\
Readability floor $f_{\min}$       & 7.0~pt (2.47~mm) \\
Table-cell size factor             & 0.88 \\
Downward expansion cap             & 80~pt (28.22~mm) \\
\midrule
Background ring margin $m$   & 6~pt (2.12~mm) \\
