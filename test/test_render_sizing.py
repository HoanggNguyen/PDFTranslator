...
def _make_doc(elements: list[dict], page_width: float = 612, page_height: float = 792) -> dict:
    return {"pages": [{"page_index": 0, "page_width": page_width,
                       "page_height": page_height, "elements": elements}]}
...
class TestAssignRenderSizes:
    ...
    def test_body_text_consistent(self):
        doc = _make_doc([
            {"label": "Text", "category": "FLOWING_TEXT", "font_size": 10.7,
             "bbox_pdf": [0, 0, 100, 20], "cells": []},
            {"label": "Text", "category": "FLOWING_TEXT", "font_size": 11.0,
             "bbox_pdf": [0, 25, 100, 45], "cells": []},
            {"label": "Text", "category": "FLOWING_TEXT", "font_size": 11.3,
             "bbox_pdf": [0, 50, 100, 70], "cells": []},
        ])
        cfg = self._cfg()
    ...
    def test_heading_hierarchy_preserved(self):
        doc = _make_doc([
            {"label": "SectionHeader", "category": "IN_PLACE", "font_size": 10.0,
             "bbox_pdf": [0, 0, 100, 20], "cells": []},
            {"label": "SectionHeader", "category": "IN_PLACE", "font_size": 14.0,
             "bbox_pdf": [0, 25, 100, 45], "cells": []},
            {"label": "SectionHeader", "category": "IN_PLACE", "font_size": 18.0,
             "bbox_pdf": [0, 50, 100, 70], "cells": []},
        ])
        cfg = self._cfg()
        sizes = assign_render_sizes(doc, cfg)
    ...
    def test_fallback_for_zero_size(self):
        doc = _make_doc([
            {"label": "Text", "category": "FLOWING_TEXT", "font_size": 0.0,
             "bbox_pdf": [0, 0, 100, 20], "cells": []},
        ])
    ...
    def test_bypass_not_included(self):
        doc = _make_doc([
            {"label": "Figure", "category": "BYPASS", "font_size": 0.0,
             "bbox_pdf": [0, 0, 100, 100], "cells": []},
        ])
        cfg = self._cfg()
        sizes = assign_render_sizes(doc, cfg)
    ...
    def test_table_cells_cluster_per_table(self):
        doc = _make_doc([
            {"label": "Table", "category": "TABLE", "font_size": 10.0,
             "bbox_pdf": [0, 0, 300, 100], "cells": [
                 {"bbox_pdf": [0, 0, 100, 20], "source_text": "A", "translated_text": "B",
                  "cell_font_size": 10.0},
                 {"bbox_pdf": [100, 0, 200, 20], "source_text": "C", "translated_text": "D",
                  "cell_font_size": 10.5},
             ]},
        ])
        cfg = self._cfg()
    ...
    def test_equation_clusters_with_body(self):
        doc = _make_doc([
            {"label": "Text", "category": "FLOWING_TEXT", "font_size": 11.0,
             "bbox_pdf": [0, 0, 100, 20], "cells": []},
            {"label": "Equation", "category": "EQUATION", "font_size": 11.2,
             "bbox_pdf": [0, 25, 100, 45], "cells": []},
        ])
        cfg = self._cfg()
        sizes = assign_render_sizes(doc, cfg)
    ...
    def test_page_scope_header_footer(self):
        ...
        pages = [
            {"page_index": 0, "page_width": 612, "page_height": 792, "elements": [
                {"label": "PageHeader", "category": "IN_PLACE", "font_size": 9.0,
                 "bbox_pdf": [0, 0, 600, 20], "cells": []},
            ]},
            {"page_index": 1, "page_width": 612, "page_height": 792, "elements": [
                {"label": "PageHeader", "category": "IN_PLACE", "font_size": 10.0,
                 "bbox_pdf": [0, 0, 600, 20], "cells": []},
            ]},
        ]
        doc = {"pages": pages}
