...
class TestScannedImports(unittest.TestCase):
    def test_scanned_module_imports(self):
        ...
        try:
            from pdf2zh import parser  # noqa: F401
    ...
    def test_stage_a_parser_imports(self):
        ...
        try:
            from pdf2zh.parser.main import StageAParser  # noqa: F401
        except ImportError as e:
    ...
    def test_ocr_utils_imports(self):
        ...
        try:
            from pdf2zh.parser.utils.ocr_text import collect_ocr_text  # noqa: F401
        except ImportError as e:
